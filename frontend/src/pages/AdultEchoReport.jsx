...
function ComboField({ label, value, onChange, withPlus = false }) {
  const listId = `dl-adult-${label.toLowerCase().replace(/[^a-z0-9]/g, '-')}`
  const defaultOptions = ['Normal', 'Abnormal', 'Intact', 'None', 'Good', 'Concordant', 'Dextrocardia']
